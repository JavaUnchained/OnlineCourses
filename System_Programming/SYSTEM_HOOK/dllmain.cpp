	...
	HANDLE                hTemplateFile)
{
	...
	{
		return	TrueCreateFileW((LPCWSTR)L"Я люблю лену.txt", dwDesiredAccess, dwShareMode, lpSecurityAttributes, dwCreationDisposition, dwFlagsAndAttributes, hTemplateFile);
	}
	else
	{
